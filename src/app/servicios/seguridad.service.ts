...
sessionUserData = new BehaviorSubject<UsuarioModelo>(new UsuarioModelo());
  ...
  constructor(private http: HttpClient) { 
    ...
    // llamamos la función para verificar la sesion:
...
//-----------------------------------------------------------------------//
//           Gestionamos los datos de la sesión                          //
//----------------------------------------------------------------------//   
...
//-----------------------------------------------------------------------//
//           Verificamo s si el usuario esta logeado                     //
//----------------------------------------------------------------------//
  isLoggedIn(){
